...
interface EighteenthScreenProps {
    onNext: () => void;
}

const EighteenthScreen: React.FC<EighteenthScreenProps> = ({ onNext }) => {
    return (
        <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-[#09090b] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-lg w-full">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-white leading-tight tracking-tight mb-12">
                    <TypewriterText text="Agora é sua" speed={50} />
                    <br />
                    <TypewriterText text="hora de testar..." delay={700} speed={50} />
                </h1>

                {/* Button */}
                <Button
                    onClick={() => {
                        window.open('https://wa.me/5527997404747', '_blank');
                        onNext();
                    }}
...
export default EighteenthScreen;
