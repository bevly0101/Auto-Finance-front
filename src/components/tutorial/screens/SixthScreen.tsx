...
const SixthScreen: React.FC<SixthScreenProps> = ({ onNext }) => {
    return (
        <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-[#09090b] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-start text-left px-8 max-w-lg w-full">
                ...
                <h1 className="text-5xl md:text-6xl font-black text-white leading-tight tracking-tight mb-12">
                    <TypewriterText text="Tudo sem você" speed={50} />
                    <br />
                    <TypewriterText text="pensar, é" delay={800} speed={50} />
                    <br />
                    <TypewriterText text="automático." delay={1400} speed={50} />
                </h1>

                {/* Subtitle */}
                <p className="text-4xl font-light italic text-white mb-16">
                    <TypewriterText text="Basta dizer." delay={2200} speed={50} />
                </p>
