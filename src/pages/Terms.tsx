  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto bg-transparent p-8 rounded-xl">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4 text-white">3. Conta do Usuário</h2>
            <p className="text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4 text-white">4. Privacidade e Dados Pessoais</h2>
            <p className="text-gray-400 mb-4">
              Respeitamos sua privacidade e protegemos seus dados pessoais de acordo com nossa <Link to="/cookies" className="text-blue-400 hover:underline">Política de Cookies</Link> e
              práticas de privacidade. Ao utilizar nosso serviço, você concorda com a coleta e uso de informações conforme descrito.
            </p>
          </section>
          
          <section>
            <h2 className="text-xl font-semibold mb-4 text-white">5. Alterações nos Termos</h2>
            <p className="text-gray-400 mb-4">
