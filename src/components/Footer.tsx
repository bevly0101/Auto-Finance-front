        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#features" onClick={handleLinkClick} className="text-gray-400 hover:text-white transition-colors">Recursos</a></li>
              <li><Link to="/plans" onClick={handleLinkClick} className="text-gray-400 hover:text-white transition-colors">Planos</Link></li>
            </ul>
          </div>
