...
const NinthScreen: React.FC<NinthScreenProps> = ({ onNext }) => {
    return (
        <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-[#09090b] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-start text-left px-8 max-w-lg w-full">
                ...
                {/* Main Title */}
                <h1 className="text-5xl md:text-6xl font-black text-white leading-tight tracking-tight mb-32">
                    <TypewriterText text="Acha que já" speed={50} />
                    <br />
                    <TypewriterText text="parou por" delay={600} speed={50} />
                    <br />
                    <TypewriterText text="aqui?" delay={1100} speed={50} />
                </h1>
