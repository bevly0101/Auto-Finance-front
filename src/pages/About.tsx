        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-transparent p-8 rounded-xl">
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold mb-4 text-white">Sobre o Auto<span className="text-blue-400">Finance</span></h1>
              <p className="text-xl text-gray-400">Simplificando sua vida financeira</p>
            </div>
            
            <div className="prose max-w-none text-gray-400 leading-relaxed space-y-6">
              <p className="text-lg">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-400 mb-2">Acompanhar sua vida financeira em tempo real</h3>
                    <p className="text-gray-400">Visualize todas as suas movimentações financeiras de forma clara e organizada.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-400 mb-2">Receber alertas e insights personalizados</h3>
                    <p className="text-gray-400">Dicas inteligentes baseadas no seu perfil e padrão de gastos.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-400 mb-2">Automatizar tarefas repetitivas</h3>
                    <p className="text-gray-400">Controle de gastos automático, sem a necessidade de inserir dados manualmente.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-400 mb-2">Visualizar relatórios e gráficos claros</h3>
                    <p className="text-gray-400">Entenda para onde vai seu dinheiro com visualizações intuitivas.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-autofinance-gray-light p-6 rounded-lg text-center mt-8">
                <h2 className="text-2xl font-semibold mb-4 text-blue-400">Junte-se a nós e simplifique sua vida financeira.</h2>
                <Link to="/signup">
